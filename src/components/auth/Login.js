...
//                             <Input className="form-control" type="email" value={this.state.email} id="email" placeholder="Email" onChange={handleChange} />
//                         </FormGroup>
//                         <FormGroup className="form-label-group py-2">
//                             <Label for="examplePassword">Password</Label>
//                             <Input className="form-control" type="password" value={this.state.password} id="password" placeholder="Password" onChange={handleChange} />
//                         </FormGroup>
